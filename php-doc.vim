...
" Default values
let g:pdv_cfg_Phpversion = "PHP version 5.3.10"
let g:pdv_cfg_Description = "File Description"
let g:pdv_cfg_Type = "mixed"
let g:pdv_cfg_Category = ""
let g:pdv_cfg_Package = ""
let g:pdv_cfg_Version = "GIT: $Id$ $Date$"
let g:pdv_cfg_Author = "Author Name <Author@example.com>"
let g:pdv_cfg_Copyright = "2012 Company Name"
...
func! PhpDocRange() range
    ...
    while l:line <= l:endLine
        ...
        " above...
        if (getline(l:line) =~ g:pdv_re_func || getline(l:line) =~ g:pdv_re_attribute || getline(l:line) =~ g:pdv_re_class || getline(l:line) =~ g:pdv_re_file) && getline(l:line - 1) !~ g:pdv_re_comment
			let l:docLines = 0
...
func! PhpDoc()
    ...
    elseif l:line =~ g:pdv_re_file
        let l:result = PhpDocFile()
...
func! PhpDocFile()
	...
	let l:modifier = substitute (l:name, g:pdv_re_file, '\1', "g")
    ...
    exe l:txtBOL . g:pdv_cfg_CommentHead . g:pdv_cfg_EOL
	exe l:txtBOL . g:pdv_cfg_Commentn . g:pdv_cfg_Description . " " . g:pdv_cfg_EOL
    exe l:txtBOL . g:pdv_cfg_Commentn . g:pdv_cfg_EOL

	exe l:txtBOL . g:pdv_cfg_Commentn . g:pdv_cfg_Phpversion . " " . g:pdv_cfg_EOL
    exe l:txtBOL . g:pdv_cfg_Commentn . g:pdv_cfg_EOL
